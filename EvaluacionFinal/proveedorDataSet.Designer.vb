...
Partial Public Class proveedorDataSet
    ...
    Partial Public Class clienteDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddclienteRow(ByVal Rif As String, ByVal Nombre As String, ByVal Telefono As String, ByVal Direccion As String, ByVal Representante As String, ByVal Email As String) As clienteRow
            Dim rowclienteRow As clienteRow = CType(Me.NewRow,clienteRow)
            Dim columnValuesArray() As Object = New Object() {Rif, Nombre, Telefono, Direccion, Representante, Email}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function FindByRif(ByVal Rif As String) As clienteRow
            Return CType(Me.Rows.Find(New Object() {Rif}),clienteRow)
        End Function
        ...
        Private Sub InitClass()
            ...
            Me.Constraints.Add(New Global.System.Data.UniqueConstraint("Constraint1", New Global.System.Data.DataColumn() {Me.columnRif}, true))
            Me.columnRif.AllowDBNull = false
            Me.columnRif.Unique = true
            Me.columnRif.MaxLength = 255
            Me.columnNombre.MaxLength = 255
            Me.columnTelefono.MaxLength = 255
            Me.columnDireccion.MaxLength = 255
            Me.columnRepresentante.MaxLength = 255
    ...
    Partial Public Class clienteRow
        ...
        Public Property Rif() As String
            Get
                Return CType(Me(Me.tablecliente.RifColumn),String)
            End Get
            Set
                Me(Me.tablecliente.RifColumn) = value
            End Set
        End Property
        ...
        Public Property Representante() As String
            Get
                Try 
                    Return CType(Me(Me.tablecliente.RepresentanteColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'Representante' de la tabla 'cliente' es DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecliente.RepresentanteColumn) = value
            End Set
        End Property
        ...
        Public Function IsRepresentanteNull() As Boolean
            Return Me.IsNull(Me.tablecliente.RepresentanteColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetRepresentanteNull()
            Me(Me.tablecliente.RepresentanteColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace proveedorDataSetTableAdapters
    ...
    Partial Public Class clienteTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `cliente` WHERE ((`Rif` = ?) AND ((? = 1 AND `Nombre` IS NULL) OR (`N"& _ 
                "ombre` = ?)) AND ((? = 1 AND `Telefono` IS NULL) OR (`Telefono` = ?)) AND ((? = "& _ 
                "1 AND `Direccion` IS NULL) OR (`Direccion` = ?)) AND ((? = 1 AND `Representante`"& _ 
                " IS NULL) OR (`Representante` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email`"& _ 
                " = ?)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_Rif", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Rif", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_Representante", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Representante", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_Representante", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Representante", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `cliente` (`Rif`, `Nombre`, `Telefono`, `Direccion`, `Representante`,"& _ 
                " `Email`) VALUES (?, ?, ?, ?, ?, ?)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Rif", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Rif", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Representante", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Representante", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `cliente` SET `Rif` = ?, `Nombre` = ?, `Telefono` = ?, `Direccion` = ?, `R"& _ 
                "epresentante` = ?, `Email` = ? WHERE ((`Rif` = ?) AND ((? = 1 AND `Nombre` IS NU"& _ 
                "LL) OR (`Nombre` = ?)) AND ((? = 1 AND `Telefono` IS NULL) OR (`Telefono` = ?)) "& _ 
                "AND ((? = 1 AND `Direccion` IS NULL) OR (`Direccion` = ?)) AND ((? = 1 AND `Repr"& _ 
                "esentante` IS NULL) OR (`Representante` = ?)) AND ((? = 1 AND `Email` IS NULL) O"& _ 
                "R (`Email` = ?)))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Rif", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Rif", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Representante", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Representante", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_Rif", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Rif", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_Representante", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Representante", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_Representante", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Representante", Global.System.Data.DataRowVersion.Original, false, Nothing))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.EvaluacionFinal.My.MySettings.Default.proveedorConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Rif, Nombre, Telefono, Direccion, Representante, Email FROM cliente"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As proveedorDataSet.clienteDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As proveedorDataSet.clienteDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As proveedorDataSet.clienteDataTable = New proveedorDataSet.clienteDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As proveedorDataSet.clienteDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As proveedorDataSet) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Rif As String, ByVal Original_Nombre As String, ByVal Original_Telefono As String, ByVal Original_Direccion As String, ByVal Original_Representante As String, ByVal Original_Email As String) As Integer
            If (Original_Rif Is Nothing) Then
                Me.Adapter.DeleteCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_Rif,String)
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(8).Value = CType(Original_Representante,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal Rif As String, ByVal Nombre As String, ByVal Telefono As String, ByVal Direccion As String, ByVal Representante As String, ByVal Email As String) As Integer
            If (Rif Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(0).Value = CType(Rif,String)
            End If
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(4).Value = CType(Representante,String)
            End If
        ...
        Public Overloads Overridable Function Update(ByVal Rif As String, ByVal Nombre As String, ByVal Telefono As String, ByVal Direccion As String, ByVal Representante As String, ByVal Email As String, ByVal Original_Rif As String, ByVal Original_Nombre As String, ByVal Original_Telefono As String, ByVal Original_Direccion As String, ByVal Original_Representante As String, ByVal Original_Email As String) As Integer
            If (Rif Is Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(0).Value = CType(Rif,String)
            End If
            If (Nombre Is Nothing) Then
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Representante,String)
            End If
            If (Email Is Nothing) Then
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_Rif,String)
            End If
            If (Original_Nombre Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(Original_Representante,String)
            End If
            If (Original_Email Is Nothing) Then
        ...
        Public Overloads Overridable Function Update(ByVal Nombre As String, ByVal Telefono As String, ByVal Direccion As String, ByVal Representante As String, ByVal Email As String, ByVal Original_Rif As String, ByVal Original_Nombre As String, ByVal Original_Telefono As String, ByVal Original_Direccion As String, ByVal Original_Representante As String, ByVal Original_Email As String) As Integer
            Return Me.Update(Original_Rif, Nombre, Telefono, Direccion, Representante, Email, Original_Rif, Original_Nombre, Original_Telefono, Original_Direccion, Original_Representante, Original_Email)
        End Function
    End Class
End Namespace
